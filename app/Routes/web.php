...
// İletişim artık harici siteye (https://enestoy.com/) yönlendiriliyor — form kaldırıldı.
...
// Herkese açık kayıt gösterme (GET): cache + rate limit
$router->get('/register', AuthController::class, 'register', [
    CacheControlMiddleware::class,
    RateLimitMiddleware::class,
]);

// Herkese açık kayıt işlemi (POST): CSRF + RateLimit
